                ...
                <Tab.Content>
                  <Tab.Pane eventKey="first">
                    <video controls width="550">
                      <source src="/resources/systems-integration/learning-objectives.mp4" type="video/mp4"/>
                  ...
                  <Tab.Pane eventKey="second">
                    <video controls width="550">
                      <source src="/resources/systems-integration/introduction.mp4" type="video/mp4"/>
                  ...
                  <Tab.Pane eventKey="third">
                    <video controls width="550">
                      <source src="/resources/systems-integration/integration-goals.mp4" type="video/mp4"/>
                  ...
                  <Tab.Pane eventKey="fourth">
                    <video controls width="550">
                      <source src="/resources/systems-integration/open-protocols.mp4" type="video/mp4"/>
                  ...
                  <Tab.Pane eventKey="fifth" placeholder="loading...">
                    <video controls width="550">
                      <source src="/resources/systems-integration/illustrating-challenges.mp4" type="video/mp4"/>
                  ...
                  <Tab.Pane eventKey="sixth" placeholder="loading...">
                    <video controls width="550">
                      <source src="/resources/systems-integration/system-vulnerabilties.mp4" type="video/mp4"/>
                  ...
                  <Tab.Pane eventKey="seventh" placeholder="loading...">
                    <video controls width="550">
                      <source src="/resources/systems-integration/take-aways.mp4" type="video/mp4"/>
