              ...
              <Col sm={9}>
                <Tab.Content>
                  <Tab.Pane eventKey="preliminary">
                    <iframe controls width="550" src="/resources/practical/equipment-requirements.pdf" title="equipment-requirements" height="400" />
                  </Tab.Pane>
                  <Tab.Pane eventKey="first">
                    <video controls width="550">
                      <source src="/resources/practical/feedback-experiment.mp4" type="video/mp4"/>
                      <track src="/resources/practical/feedback-experiment.vtt" label="English auto-captions" kind="captions" srclang="en" default/>
                    </video>
                  </Tab.Pane>
                  <Tab.Pane eventKey="second">
                    <video controls width="550">
                      <source src="/resources/practical/feedback-reflections.mp4" type="video/mp4"/>
                  ...
                  <Tab.Pane eventKey="third" placeholder="loading...">
                    <video controls width="550">
                      <source src="/resources/practical/introducing-ble.mp4" type="video/mp4"/>
                  ...
                  <Tab.Pane eventKey="fourth" placeholder="loading...">
                    <video controls width="550">
                      <source src="/resources/practical/gateway-instructions.mp4" type="video/mp4"/>
                  ...
                  <Tab.Pane eventKey="fifth" placeholder="loading...">
                    <video controls width="550">
                      <source src="/resources/practical/gateway-results.mp4" type="video/mp4"/>
                  ...
                  <Tab.Pane eventKey="sixth" placeholder="loading...">
                    <video controls width="550">
                      <source src="/resources/practical/gateway-reflections.mp4" type="video/mp4"/>
                      <track src="/resources/practical/gateway-reflections.vtt" label="English auto-captions" kind="captions" srclang="en" default/>
                    </video>
                  </Tab.Pane>
                  <Tab.Pane eventKey="seventh">
                    <video controls width="550">
                      <source src="/resources/practical/introducing-dht11.mp4" type="video/mp4"/>
                  ...
                  <Tab.Pane eventKey="eighth" placeholder="loading...">
                    <video controls width="550">
                      <source src="/resources/practical/dht11-display-instructions.mp4" type="video/mp4"/>
                  ...
                  <Tab.Pane eventKey="ninth" placeholder="loading...">
                    <video controls width="550">
                      <source src="/resources/practical/dht11-mqtt-instructions.mp4" type="video/mp4"/>
                  ...
                  <Tab.Pane eventKey="tenth" placeholder="loading...">
                    <video controls width="550">
                      <source src="/resources/practical/dht11-mqtt-results.mp4" type="video/mp4"/>
                  ...
                  <Tab.Pane eventKey="eleventh" placeholder="loading...">
                    <video controls width="550">
                      <source src="/resources/practical/dht11-reflections.mp4" type="video/mp4"/>
